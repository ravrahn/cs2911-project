	...
	public Maze3DComponent() throws IOException {
		...
		addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if ((e.getKeyCode() == KeyEvent.VK_UP || e.getKeyCode() == KeyEvent.VK_W) && !maze.getWall(player, playerFacing)) {
				...
				} else if ((e.getKeyCode() == KeyEvent.VK_DOWN || e.getKeyCode() == KeyEvent.VK_S) && !maze.getWall(player, (playerFacing + 2) % 4)) {
					if (playerFacing == Maze.UP) {
						player.setY(player.getY() + 1);
					} else if (playerFacing == Maze.RIGHT) {
						player.setX(player.getX() - 1);
	...
	public void paintComponent(Graphics g) {
		...
		while (true) {
			if (maze.getWall(tempCoord, (playerFacing + 1) % 4)) {
				int[] polygonXs = {(centreX / depth), (int) ((centreX / (depth + 0.5))), (int) ((centreX / (depth + 0.5))), (centreX / depth)};
				int[] polygonYs = {-(centreY / depth), (int) (-(centreY / (depth + 0.5))), (int) ((centreY / (depth + 0.5))), (centreY / depth)};
				...
				int[] polygonXs = {(centreX / depth), (int) ((centreX / (depth + 0.5))), (int) ((centreX / (depth + 0.5))), (centreX / depth)};
				int[] polygonYs = {(int) (-(centreY / (depth + 0.5))), (int) (-(centreY / (depth + 0.5))), (int) ((centreY / (depth + 0.5))), (int) ((centreY / (depth + 0.5)))};
				Shape s = new Polygon(polygonXs, polygonYs, polygonXs.length);
			...
			int[] polygonXs1 = {(int) ((centreX / (depth + 0.5))), (int) ((centreX / (depth + 1))), (int) ((centreX / (depth + 1))), (int) ((centreX / (depth + 0.5)))};
			int[] polygonYs1 = {(int) (-(centreY / (depth + 0.5))), (int) (-(centreY / (depth + 1))), (int) ((centreY / (depth + 1))), (int) ((centreY / (depth + 0.5)))};
			Shape s1 = new Polygon(polygonXs1, polygonYs1, polygonXs1.length);
			int[] polygonXs2 = {(int) (-(centreX / (depth + 0.5))), (int) (-(centreX / (depth + 1))), (int) (-(centreX / (depth + 1))), (int) (-(centreX / (depth + 0.5)))};
			int[] polygonYs2 = {(int) (-(centreY / (depth + 0.5))), (int) (-(centreY / (depth + 1))), (int) ((centreY / (depth + 1))), (int) ((centreY / (depth + 0.5)))};
		...
		int[] polygonXs = {(int) ((centreX / (depth + 0.5))), (int) (-(centreX / (depth + 0.5))), (int) (-(centreX / (depth + 0.5))), (int) ((centreX / (depth + 0.5)))};
		int[] polygonYs = {(int) (-(centreY / (depth + 0.5))), (int) (-(centreY / (depth + 0.5))), (int) ((centreY / (depth + 0.5))), (int) ((centreY / (depth + 0.5)))};
		Shape s = new Polygon(polygonXs, polygonYs, polygonXs.length);
		g2D.setColor(frontColor);
		g2D.fill(s);
